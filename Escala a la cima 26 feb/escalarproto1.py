...
while True:
    ...
    if salto:
        ...
        elif nivel1.get_at((posicion_personaje[0] + persona.get_width() // 2, posicion_personaje[1] + persona.get_height() + int(altura_salto))) == color_granate:
            salto = False
            altura_salto = 0
            velocidad_salto = 10  # Reiniciar velocidad de salto
        elif nivel1.get_at((posicion_personaje[0] + persona.get_width() // 2, posicion_personaje[1] + persona.get_height() + 1)) == color_granate:
            altura_salto = 0
            velocidad_salto = 10  # Reiniciar velocidad de salto
...
#Arreglar error de colisión inversa y comprobar si la caida acaba al tocar granate
